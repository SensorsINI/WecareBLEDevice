...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set SPI_MISO [ create_bd_port -dir O -type data SPI_MISO ]
  set SPI_MOSI [ create_bd_port -dir I -type data SPI_MOSI ]
  set SPI_SCK [ create_bd_port -dir I -type clk SPI_SCK ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {32000000} \
 ] $SPI_SCK
  set SPI_SS_0 [ create_bd_port -dir I SPI_SS_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#UART 1#UART 1#Unbonded#Unbonded#GPIO#GPIO} \
  ...
  connect_bd_net -net SPI_MOSI_1 [get_bd_ports SPI_MOSI] [get_bd_pins processing_system7_0/SPI0_MOSI_I] [get_bd_pins system_ila_0/probe1]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets SPI_MOSI_1]
  connect_bd_net -net SPI_SCK_1 [get_bd_ports SPI_SCK] [get_bd_pins processing_system7_0/SPI0_SCLK_I] [get_bd_pins system_ila_0/probe0]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets SPI_SCK_1]
  connect_bd_net -net SPI_SS_0_1 [get_bd_ports SPI_SS_0] [get_bd_pins processing_system7_0/SPI0_SS_I] [get_bd_pins system_ila_0/probe3]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets SPI_SS_0_1]
  ...
  connect_bd_net -net processing_system7_0_SPI0_MISO_O [get_bd_ports SPI_MISO] [get_bd_pins processing_system7_0/SPI0_MISO_O] [get_bd_pins system_ila_0/probe2]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets processing_system7_0_SPI0_MISO_O]
